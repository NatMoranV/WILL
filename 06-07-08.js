...
function crearClasePersona() {
  class Persona {
    ...
    getFriends() {
      ...
      // Tu código aca:
      var newArray = this.amigos.map(x => x.nombre);
      return newArray
    }
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
      var newArray3 = this.amigos.map(x => x.edad);
      var total = 0;
      for (const number of newArray3) {
        total += number / newArray3.length;
      }
      return total;
    }
  };
